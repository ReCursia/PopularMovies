package com.recursia.popularmovies.presentation.ui.fragments;
...
import com.recursia.popularmovies.presentation.views.MoviesListContract;
...
public class MoviesListFragment extends MvpAppCompatFragment implements MoviesListContract {
    ...
    MoviesListPresenter providePresenter() {
        ...
        return new MoviesListPresenter(app.getMoviesListInteractor(), strategy);
    }
