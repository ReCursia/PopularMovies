...
public class SearchScreenActivity extends MvpAppCompatActivity implements SearchScreenContract {
    ...
    SearchScreenPresenter providePresenter() {
        ...
        return new SearchScreenPresenter(app.getSearchScreenInteractor());
    }
